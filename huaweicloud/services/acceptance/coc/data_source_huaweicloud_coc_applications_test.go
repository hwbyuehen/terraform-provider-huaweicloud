...
# Filter by Parent Application id
locals {
...
locals {
  code_filter_result = data.huaweicloud_coc_applications.code_filter.data[0].code
}

output "code_filter_useful" {
  value = local.code_filter_result == local.code
}

# Filter by Fuzzy query the application name
locals {
